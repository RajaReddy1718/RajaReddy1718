...
**Languages & Data**
`Python` `SQL` `PL/SQL` `Pandas` `NumPy`

**ML & AI**
`PyTorch` `scikit-learn` `TensorFlow` `OpenCV` `PyWavelets`

**Data Engineering**
`ETL Pipelines` `Batch Processing` `Data Warehousing` `Schema Design` `Data Quality`

**Cloud & Tools**
`AWS (S3, EC2, Glue)` `Azure (Data Factory, Databricks)` `Snowflake` `Docker` `Git` `Linux`
...
### 🧠 [Medical Image Fusion using DT-CWT](https://github.com/RajaReddy1718/medical-image-fusion)
...
- **Published:** IJEAST 2022 — [DOI: 10.33564/IJEAST.2022.v06i12.054](https://doi.org/10.33564/IJEAST.2022.v06i12.054)
- `Python` `Flask` `OpenCV` `NumPy` `PyWavelets`

### 📡 [ML-Based Network Throughput Prediction](https://github.com/RajaReddy1718/ACN-Final-Project)
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Rajasekhar%20Reddy%20Kallam-blue?style=flat&logo=linkedin)](https://www.linkedin.com/in/rajasekhar-reddy-kallam-bb7306221)
[![Email](https://img.shields.io/badge/Email-kallamrajasekharreddy17%40gmail.com-red?style=flat&logo=gmail)](mailto:kallamrajasekharreddy17@gmail.com)
